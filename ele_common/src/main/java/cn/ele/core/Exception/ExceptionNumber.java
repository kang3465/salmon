...
public class ExceptionNumber {
    ...
    public static final int ERR_PUBLISH_PUBLISHED_CONTENTS = 238;
    ...
    public static final int MSG_EXCEPTION_MIN_VALUE = 200000;
    public static final int MSG_NOT_SET_PUBLISH_PROPERTIES = 200001;
    public static final int MSG_NOT_SET_OUTLINE_TEMPLATE = 200002;
    public static final int MSG_NOT_SET_DETAIL_TEMPLATE = 200003;
    public static final int MSG_SET_TO_CANNOT_PUBLISH = 200004;
    public static final int MSG_STATUS_CANNOT_PUBLISH = 200005;
    public static final int ERR_OBJ_NOTFOUND = 200006;
    public static final int MSG_NOT_SET_DEFAULT_CHANNEL = 200007;
    public static final int INFO_ERROR_MSG = 11111;

    public ExceptionNumber() {
    }

    public static String getErrNoMsg(int var0) {
        String var1 = ExceptionMessages.getString(var0);
        return var1 == null ? ExceptionMessages.getString(0) : var1;
    }
}
